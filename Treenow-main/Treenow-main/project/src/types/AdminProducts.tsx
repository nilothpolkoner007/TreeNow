...
const AdminProductsOrders = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [productsRes, ordersRes] = await Promise.all([
        axios.get(`${import.meta.env.VITE_BACKEND_SERVER}/products`, { headers }),
        axios.get(`${import.meta.env.VITE_BACKEND_SERVER}/orders`, { headers }),
      ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_SERVER}/products`, productData, {
  ...
  const handleDeleteProduct = async (id) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_BACKEND_SERVER}/products/${id}`, {
