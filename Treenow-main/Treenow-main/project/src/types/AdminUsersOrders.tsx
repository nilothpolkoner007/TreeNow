  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const usersRes = await axios.get(`${import.meta.env.VITE_BACKEND_SERVER}/admin/users`, { headers });
        const ordersRes = await axios.get(`${import.meta.env.VITE_BACKEND_SERVER}/admin/orders`, { headers });
